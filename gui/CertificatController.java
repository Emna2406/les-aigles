...
if ((patcert .getText().matches("[0-9]")) || (patcert .getText().length() == 0)) {
  ...
  idcert.setText(null);
    ...
    @FXML
    private void Performed(ActionEvent event) throws IOException, NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException {
