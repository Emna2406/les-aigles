...
class QrCodeController extends AbstractController
{
    ...
    /**
     * Summary of index
     * @param BuilderInterface $qrbuilder
     * @param Produit $pe
     * @return Response
     */
    public function index(): Response
    {
        ...
        $logo = Logo::create('back/img/user.jpg')
            ->setResizeToWidth(60);
        ...
        return $this->render('qr_code.html.twig', $qrCodes);
    }
   /* public function index(BuilderInterface $qrbuilder ,Produit $pe): Response
    {
        $qrCodeContent = $pe->getNom() . ' ' . $pe->getStock()    ;
        return $this->render('templates/qr_code.html.twig', [
